    ...
    handleSlashOversize(attackDirection = null) {
        ...
        if (this.player.equipmentLayers) {
            ...
            this.player.equipmentLayers.forEach((equipLayer, slot) => {
                ...
                // Ensure equipment layer is visible and play attack animation
                equipLayer.setVisible(true);
    ...
    switch (data.type) {
        ...
        case 'equipmentUpdate':
            ...
            if (scene && scene.player) {
                ...
                scene.updateEquipmentLayers(scene.player, data.equipment);
            } else {
                console.warn('[EQUIP] scene or scene.player not found - cannot update equipment visuals');
            }
